...
<ExternalQuestion xmlns="http://mechanicalturk.amazonaws.com/AWSMechanicalTurkDataSchemas/2006-07-14/ExternalQuestion.xsd">
  <ExternalURL>https://security.maths22.com/submit</ExternalURL>
...
response = client.create_hit(
    ...
    Title='Write spear-phishing templates',
    Keywords='writing, phishing',
    Description='Write some (fake) spear-phishing emails',
    Question=question,
